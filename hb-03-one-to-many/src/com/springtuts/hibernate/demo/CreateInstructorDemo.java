...
public class CreateInstructorDemo {
	...
	public static void main(String[] args) {
		...
		try {
			// create the objects		
			Instructor instructor = new Instructor("Susan", "Gupta", "susangupta@yopmail.com");
			
			InstructorDetail instructorDetail = new InstructorDetail("https://www.susanvlogs.com/youtube", "Vlogging");
